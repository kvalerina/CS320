...
import main.java.contact.Contact;
import main.java.contact.ContactService;
...
public class ContactServiceTest {
	...
	void testDeleteContact() {
		...
		service.displayContactList();
		assertEquals(service.getContactList(), contactListEmpty, "The contact was not deleted.");
	}
